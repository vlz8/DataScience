...
Predicts the likelihood of death due to heart failure using clinical data and supervised machine learning. Cardiovascular diseases are the leading cause of death globally, claiming an estimated 17.9 million lives each year. 
Early detection through predictive modeling can support timely medical intervention.
